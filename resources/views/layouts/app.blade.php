            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    @if (in_array(request()->user()->role, ['admin', 'teknik']))
                        ...
                        <li class="menu-item {{ Route::is('Kriteria::*') ? 'active' : '' }}">
                            <a href="{{ route('Kriteria::index') }}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-table"></i>
                                <div data-i18n="Tables">Kriteria</div>
                            </a>
                        </li>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('Hasil::index') }}" class="menu-link">
                            ...
                            <div data-i18n="Tables">Hasil</div>
                        </a>
                    </li>
                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center text-primary" style="font-weight: bold;">
                                SISTEM PENDUKUNG KEPUTUSAN PELINDO TERMINAL PETIKEMAS
                            </div>
                        </div>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                &copy;Pelindo Terminal Petikemas
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
