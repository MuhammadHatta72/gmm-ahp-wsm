                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            @foreach ($alatMaster as $alatmaster)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('Alat-Master::destroy', $alatmaster->id) }}" method="post"
                                            class="d-inline" id="deleteForm{{ $alatmaster->id }}">
                                            <a href="{{ route('Alat-Master::edit', $alatmaster->id) }}"
                                                class="btn btn-outline-info" data-bs-toggle="tooltip" data-bs-offset="0,4"
