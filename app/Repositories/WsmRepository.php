        ...
        try {
            ...
            foreach ($equipments as $index => $equipment) {
                ...
                $_store[] = [
                    'kode'         => $equipment->kode,
                    'nama'         => $equipment->nama,
                    'utilisasi'    => $equipment->utilisasi == 0 ? $equipment->utilisasi : 1,
                    'availability' => $equipment->availability == 0 ? $equipment->availability : 1,
                    'reliability'  => $equipment->reliability == 0 ? $equipment->reliability : 1,
                    'idle'         => $equipment->idle == 0 ? $equipment->idle : 1,
